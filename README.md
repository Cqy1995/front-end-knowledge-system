...
自我介绍：  
您好，我叫陈启元，来自辽宁丹东，今年26岁，毕业于辽宁科技学院，主修计算机科学与技术，17年11月来北京工作，第一家公司叫中企聚易（北京）网络科技有限公司，主要用的的技术栈是js和jq,负责凯旋网和找工网两个项目的前端工作，主要职责是页面开发，动画效果与业务逻辑的实现。19年4月任职北京嘉楼信息技术有限公司，前端开发工程师职位，主要用的的技术栈是vue,angular以及微信小程序，负责retail,pmc,scrm等项目，主要职责负责业务开发，前端框架的搭建，性能优化等。以上是我的自我介绍，谢谢。

* git merge --abort 保留当前分支的代码，忽略其他分支的代码。  好
* git merge --abort 保留当前分支的代码，忽略其他分支的代码。  
